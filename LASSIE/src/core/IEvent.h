...
class EventDiscretePackage{
  ...
  public:
    ...
    std::string getXMLString();
    bool link(Project* _project, IEvent* _thisEvent);
...
class EventLayer {
  ...
  public:
    ...
    void link (Project* _project, IEvent* _thisEvent);
...
public:
  ...
  std::string getXMLString();
  std::string getXMLTHMLB();
  std::string getXMLSound();
  std::string getXMLEnv();
  std::string getXMLSiv();
  std::string getXMLSpa();
  std::string getXMLPat();
  std::string getXMLRev();
  std::string getXMLFil();
  std::string getXMLNote();
  std::string getXMLMea();
  static std::string getFunctionString(DOMElement* _thisFunctionElement);
