/*******************************************************************************
 *
 *  File Name     : envelope_struct.hpp, originally EnvelopeLibraryEntry.hpp
...
public:
  ...
  EnvelopeLibraryEntry(EnvelopeLibraryEntry &other, int _number);
  ~EnvelopeLibraryEntry();
  int count();
  
  EnvelopeLibraryEntry* create();
  EnvelopeLibraryEntry* duplicate(EnvelopeLibraryEntry &other);
  QString get_number_as_qstring();
